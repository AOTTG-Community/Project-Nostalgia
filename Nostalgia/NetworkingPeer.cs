...
internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
    ...
    public void OnEvent(EventData photonEvent)
    {
        ...
        switch (code)
        {
            ...
            case 0xe4:
                ...
                {
                    this.mQueuePosition = (int) photonEvent[0xdf];
                }
                break;
            ...
            case 230:
            {
                ...
                try
                {
                    while (enumerator.MoveNext())
                    {
                        ...
                        this.mGameList[str] = new RoomInfo(str, (ExitGames.Client.Photon.Hashtable) entry.Value);
                    }
                }
                finally
                {
    ...
    {
        if (((this.mMasterClient == null) || (this.mMasterClient.ID == playerId)) || !this.mActors.ContainsKey(playerId))
        {
            return false;
        }
        if (sync)
