            ...
            if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
            {
                ...
                else if (this.rockPhase == 5)
                {
                    ...
                    if ((this.checkPoints.Count > 0) && (UnityEngine.Random.Range(0, 0xbb8) < (10 - this.checkPoints.Count)))
                    {
                        ...
                        Vector3 vector5 = (Vector3) (quaternion * new Vector3(UnityEngine.Random.Range((float) 100f, (float) 200f), 0f, 0f));
                    ...
                    Vector3 vector7 = (Vector3) (base.transform.forward * 6f);
                    Vector3 vector8 = base.rigidbody.velocity;
                    Vector3 vector9 = vector7 - vector8;
                    vector9.x = Mathf.Clamp(vector9.x, -this.maxVelocityChange, this.maxVelocityChange);
                    vector9.z = Mathf.Clamp(vector9.z, -this.maxVelocityChange, this.maxVelocityChange);
                    vector9.y = 0f;
                    base.rigidbody.AddForce(vector9, ForceMode.VelocityChange);
                    base.rigidbody.AddForce(new Vector3(0f, -this.gravity * base.rigidbody.mass, 0f));
                    Vector3 vector10 = this.targetCheckPt - base.transform.position;
