...
internal class PhotonHandler : Photon.MonoBehaviour, IPhotonPeerListener
{
    ...
    protected void Update()
    {
        ...
        else if ((((PhotonNetwork.connectionStateDetailed != global::PeerState.PeerCreated) && (PhotonNetwork.connectionStateDetailed != global::PeerState.Disconnected)) && !PhotonNetwork.offlineMode) && PhotonNetwork.isMessageQueueRunning)
        {
...
//        internal bool connectToBest; //RD:That line was detected as a duplicated variable declaration
        ...
        public bool MoveNext()
        {
            ...
            {
                if ((PhotonNetwork.connectionStateDetailed != global::PeerState.ConnectingToNameServer) && (PhotonNetwork.connectionStateDetailed != global::PeerState.ConnectedToNameServer))
                {
            ...
            this.s_89__1 = PhotonNetwork.networkingPeer.AvailableRegions.GetEnumerator();
            try
            {
                while (this.s_89__1.MoveNext())
                {
                    this.region__2 = this.s_89__1.Current;
                    PhotonHandler.SP.StartCoroutine(this.pingManager__0.PingSocket(this.region__2));
                }
            }
            finally
            {
                this.s_89__1.Dispose();
            }
        Label_01A7:
