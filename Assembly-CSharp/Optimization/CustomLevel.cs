...
namespace Optimization
{
    static class CustomLevel
    {
        ...
        //Change this variable to set custom map. Example: 
        //CustomLevel.currentScript = GUILayout.TextField(CustomLevel.currentScript);
        //This will automatically set map.
        public static string currentScript = "";
        //!!!!NOT TESTED!!!
        //Change this variable to set custom logic. Example: 
        //CustomLevel.currentScriptLogic = GUILayout.TextField(CustomLevel.currentScriptLogic);
        //This will automatically set map.
        ...
        public static void compileScript(string str)
        {
            ...
            for (int num3 = 0; num3 < strArray2.Length; num3++)
            {
                ...
                else
                {
                    ...
                    {
                        int num7 = num3 + 1;
                        InRoomChat.Chat.AddLine("Script Error: Parentheses not equal! (line " + num7.ToString() + ")");
                        flag = true;
                    }
                    if (num6 % 2 != 0)
                    {
                        InRoomChat.Chat.AddLine("Script Error: Quotations not equal! (line " + (num3 + 1).ToString() + ")");
                        flag = true;
                    }
                }
            }
            if (num != num2)
            {
                InRoomChat.Chat.AddLine("Script Error: Bracket count not equivalent!");
                flag = true;
            }
            if (!flag)
            {
                ...
                {
                    InRoomChat.Chat.AddLine(exception.Message);
                }
            }
        }
        ...
        private static void customLevelClient(string[] content, bool renewHash)
        {
            ...
            if (!flag && !flag2)
            {
                for (int num2 = 0; num2 < content.Length; num2++)
                {
                    string[] strArray2 = content[num2].Split(new char[]
                    {
                        ','
                    });
                        ...
                        if (strArray2[2] != "default")
                        {
                            if (strArray2[2].StartsWith("transparent"))
                            {
                                ...
                                foreach (Renderer renderer in obj2.GetComponentsInChildren<Renderer>())
                                {
                                    ...
                                    if (Convert.ToSingle(strArray2[10]) != 1f || Convert.ToSingle(strArray2[11]) != 1f)
                                    {
                            ...
                            else
                            {
                                ...
                                {
                                    renderer2.material = (Material)RCManager.Load(strArray2[2]);
                                    if (Convert.ToSingle(strArray2[10]) != 1f || Convert.ToSingle(strArray2[11]) != 1f)
                                    {
                                        renderer2.material.mainTextureScale = new Vector2(renderer2.material.mainTextureScale.x * Convert.ToSingle(strArray2[10]), renderer2.material.mainTextureScale.y * Convert.ToSingle(strArray2[11]));
                                    }
                                }
                            }
                        }
                        float num5 = obj2.transform.localScale.x * Convert.ToSingle(strArray2[3]);
                        num5 -= 0.001f;
                        float num6 = obj2.transform.localScale.y * Convert.ToSingle(strArray2[4]);
                        float num7 = obj2.transform.localScale.z * Convert.ToSingle(strArray2[5]);
                        obj2.transform.localScale = new Vector3(num5, num6, num7);
                        if (strArray2[6] != "0")
                        {
                            Color color = new Color(Convert.ToSingle(strArray2[7]), Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), num3);
                    ...
                    else if (strArray2[0].StartsWith("base"))
                    {
                        ...
                        {
                            UnityEngine.Object.Instantiate(Resources.Load(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[2]), Convert.ToSingle(strArray2[3]), Convert.ToSingle(strArray2[4])), new Quaternion(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7]), Convert.ToSingle(strArray2[8])));
                        }
                        else
                        {
                            float num9 = 1f;
                            ...
                            if (strArray2[2] != "default")
                            {
                                ...
                                {
                                    float num10;
                                    if (float.TryParse(strArray2[2].Substring(11), out num10))
                                    {
                                        num9 = num10;
                                    }
                                    foreach (Renderer renderer3 in obj3.GetComponentsInChildren<Renderer>())
                                    {
                                        ...
                                        if (Convert.ToSingle(strArray2[10]) != 1f || Convert.ToSingle(strArray2[11]) != 1f)
                                        {
                                            renderer3.material.mainTextureScale = new Vector2(renderer3.material.mainTextureScale.x * Convert.ToSingle(strArray2[10]), renderer3.material.mainTextureScale.y * Convert.ToSingle(strArray2[11]));
                                        }
                                    }
                                }
                                else
                                {
                                    foreach (Renderer renderer4 in obj3.GetComponentsInChildren<Renderer>())
                                    {
                                        ...
                                        {
                                            renderer4.material = (Material)RCManager.Load(strArray2[2]);
                                            if (Convert.ToSingle(strArray2[10]) != 1f || Convert.ToSingle(strArray2[11]) != 1f)
                                            {
                                                renderer4.material.mainTextureScale = new Vector2(renderer4.material.mainTextureScale.x * Convert.ToSingle(strArray2[10]), renderer4.material.mainTextureScale.y * Convert.ToSingle(strArray2[11]));
                                            }
                                        }
                                    }
                                }
                            }
                            float num11 = obj3.transform.localScale.x * Convert.ToSingle(strArray2[3]);
                            num11 -= 0.001f;
                            float num12 = obj3.transform.localScale.y * Convert.ToSingle(strArray2[4]);
                            float num13 = obj3.transform.localScale.z * Convert.ToSingle(strArray2[5]);
                            obj3.transform.localScale = new Vector3(num11, num12, num13);
                            if (strArray2[6] != "0")
                            {
                                Color color2 = new Color(Convert.ToSingle(strArray2[7]), Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), num9);
                    ...
                    else if (strArray2[0].StartsWith("misc"))
                    {
                        ...
                        {
                            GameObject gameObject = (GameObject)UnityEngine.Object.Instantiate(CacheResources.RCLoad(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7])), new Quaternion(Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), Convert.ToSingle(strArray2[10]), Convert.ToSingle(strArray2[11])));
                            float num15 = gameObject.transform.localScale.x * Convert.ToSingle(strArray2[2]);
                            num15 -= 0.001f;
                            float num16 = gameObject.transform.localScale.y * Convert.ToSingle(strArray2[3]);
                            float num17 = gameObject.transform.localScale.z * Convert.ToSingle(strArray2[4]);
                            gameObject.transform.localScale = new Vector3(num15, num16, num17);
                        }
                        else if (strArray2[1].StartsWith("racingStart"))
                        {
                            GameObject obj4 = (GameObject)UnityEngine.Object.Instantiate(CacheResources.RCLoad(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7])), new Quaternion(Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), Convert.ToSingle(strArray2[10]), Convert.ToSingle(strArray2[11])));
                            float num18 = obj4.transform.localScale.x * Convert.ToSingle(strArray2[2]);
                            num18 -= 0.001f;
                            float num19 = obj4.transform.localScale.y * Convert.ToSingle(strArray2[3]);
                            float num20 = obj4.transform.localScale.z * Convert.ToSingle(strArray2[4]);
                        ...
                        {
                            GameObject gameObject2 = (GameObject)UnityEngine.Object.Instantiate(CacheResources.RCLoad(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7])), new Quaternion(Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), Convert.ToSingle(strArray2[10]), Convert.ToSingle(strArray2[11])));
                            float num21 = gameObject2.transform.localScale.x * Convert.ToSingle(strArray2[2]);
                            num21 -= 0.001f;
                            float num22 = gameObject2.transform.localScale.y * Convert.ToSingle(strArray2[3]);
                            float num23 = gameObject2.transform.localScale.z * Convert.ToSingle(strArray2[4]);
                            gameObject2.transform.localScale = new Vector3(num21, num22, num23);
                            gameObject2.AddComponent<LevelTriggerRacingEnd>();
                        }
                        else if (strArray2[1].StartsWith("region") && PhotonNetwork.IsMasterClient)
                        {
                            Vector3 loc = new Vector3(Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7]), Convert.ToSingle(strArray2[8]));
                            RCRegion region = new RCRegion(loc, Convert.ToSingle(strArray2[3]), Convert.ToSingle(strArray2[4]), Convert.ToSingle(strArray2[5]));
                            string key = strArray2[2];
                            if (RCManager.RCRegionTriggers.ContainsKey(key))
                            {
                                ...
                                float num24 = obj5.transform.localScale.x * Convert.ToSingle(strArray2[3]);
                                num24 -= 0.001f;
                                float num25 = obj5.transform.localScale.y * Convert.ToSingle(strArray2[4]);
                                float num26 = obj5.transform.localScale.z * Convert.ToSingle(strArray2[5]);
                    ...
                    {
                        if (strArray2[1].StartsWith("start"))
                        {
                            GameObject obj6 = (GameObject)UnityEngine.Object.Instantiate(CacheResources.RCLoad(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7])), new Quaternion(Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), Convert.ToSingle(strArray2[10]), Convert.ToSingle(strArray2[11])));
                            float num27 = obj6.transform.localScale.x * Convert.ToSingle(strArray2[2]);
                            num27 -= 0.001f;
                            float num28 = obj6.transform.localScale.y * Convert.ToSingle(strArray2[3]);
                            float num29 = obj6.transform.localScale.z * Convert.ToSingle(strArray2[4]);
                        ...
                        else if (strArray2[1].StartsWith("end"))
                        {
                            GameObject gameObject3 = (GameObject)UnityEngine.Object.Instantiate(CacheResources.RCLoad(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7])), new Quaternion(Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), Convert.ToSingle(strArray2[10]), Convert.ToSingle(strArray2[11])));
                            float num30 = gameObject3.transform.localScale.x * Convert.ToSingle(strArray2[2]);
                            num30 -= 0.001f;
                            float num31 = gameObject3.transform.localScale.y * Convert.ToSingle(strArray2[3]);
                            float num32 = gameObject3.transform.localScale.z * Convert.ToSingle(strArray2[4]);
                        ...
                        else if (strArray2[1].StartsWith("kill"))
                        {
                            GameObject gameObject4 = (GameObject)UnityEngine.Object.Instantiate(CacheResources.RCLoad(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7])), new Quaternion(Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), Convert.ToSingle(strArray2[10]), Convert.ToSingle(strArray2[11])));
                            float num33 = gameObject4.transform.localScale.x * Convert.ToSingle(strArray2[2]);
                            num33 -= 0.001f;
                            float num34 = gameObject4.transform.localScale.y * Convert.ToSingle(strArray2[3]);
                            float num35 = gameObject4.transform.localScale.z * Convert.ToSingle(strArray2[4]);
                        ...
                        else if (strArray2[1].StartsWith("checkpoint"))
                        {
                            GameObject gameObject5 = (GameObject)UnityEngine.Object.Instantiate(CacheResources.RCLoad(strArray2[1]), new Vector3(Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]), Convert.ToSingle(strArray2[7])), new Quaternion(Convert.ToSingle(strArray2[8]), Convert.ToSingle(strArray2[9]), Convert.ToSingle(strArray2[10]), Convert.ToSingle(strArray2[11])));
                            float num36 = gameObject5.transform.localScale.x * Convert.ToSingle(strArray2[2]);
                            num36 -= 0.001f;
                            float num37 = gameObject5.transform.localScale.y * Convert.ToSingle(strArray2[3]);
                            float num38 = gameObject5.transform.localScale.z * Convert.ToSingle(strArray2[4]);
                    ...
                    else if (strArray2[0].StartsWith("map"))
                    {
                        if (strArray2[1].StartsWith("disablebounds"))
                        {
                            UnityEngine.Object.Destroy(GameObject.Find("gameobjectOutSide"));
                            UnityEngine.Object.Instantiate(RCManager.Load("outside"));
                        }
                    }
                    else if (PhotonNetwork.IsMasterClient && strArray2[0].StartsWith("photon") && !strArray2[1].StartsWith("Cannon"))
                    {
                        TitanSpawner item = new TitanSpawner();
                        float num39 = 30f;
                        float num40;
                        if (float.TryParse(strArray2[2], out num40))
                        {
                            num39 = Mathf.Max(Convert.ToSingle(strArray2[2]), 1f);
                        }
                        item.time = num39;
                        item.delay = num39;
                        item.name = strArray2[1];
                        if (strArray2[3] == "1")
                        {
                            item.endless = true;
                        }
                        ...
                        item.location = new Vector3(Convert.ToSingle(strArray2[4]), Convert.ToSingle(strArray2[5]), Convert.ToSingle(strArray2[6]));
        ...
        public static IEnumerator LoadLevel()
        {
            ...
            {
                int j;
                for (int i = 0; i < levelCache.Count; i = j + 1)
                {
                    foreach (PhotonPlayer player in PhotonNetwork.playerList)
                    {
                        if (!player.IsLocal)
                        {
                            if (player.Properties["currentLevel"] != null && currentLevel != string.Empty && player.Properties["currentLevel"] as string == currentLevel)
                            {
                                if (i == 0)
                                {
                                    FengGameManagerMKII.FGM.BasePV.RPC("customlevelRPC", player, new object[]
                                    {
                                        new string[]
                                        {
                                            "loadcached"
            ...
            {
                FengGameManagerMKII.FGM.BasePV.RPC("customlevelRPC", PhotonTargets.Others, new object[]
                {
                    new string[]
                    {
                        "loadempty"
        ...
        {
            int num;
            for (int i = 0; i < levelCache.Count; i = num + 1)
            {
        ...
        {
            FengGameManagerMKII.FGM.RoundTime = 0f;
            logicLoaded = false;
            customLevelLoaded = true;
            if (FengGameManagerMKII.Level.Name.StartsWith("Custom") && IN_GAME_MAIN_CAMERA.GameType == GameType.Multi)
            {
                ...
                if (PhotonNetwork.IsMasterClient)
                {
                    ...
                    logicLoaded = true;
                    RCManager.SpawnCupCustom = Math.Min(50, RCManager.SpawnCupCustom);
                    string methodName = "clearlevel";
                    PhotonTargets target = PhotonTargets.AllBuffered;
                    object[] array5 = new object[2];
                    array5[0] = (from x in new string[7]
                                 select string.Empty).ToArray<string>();
                    array5[1] = RCManager.GameType;
                    FengGameManagerMKII.FGM.BasePV.RPC(methodName, target, array5);
        ...
        //public static void SetCustomMap(int id, bool random = false)
        //{
        //    string[] files = Directory.GetFiles(MapsGUI.MapsPath);
        //    if (id > files.Length || id < 1)
        //    {
        //        return;
        //    }
        //    int ID = random ? UnityEngine.Random.Range(0, files.Length - 1) : (id - 1);
        //    currentScript = File.ReadAllText(files[ID]);
        //    string name = files[ID].Replace(".txt", "").Replace(MapsGUI.MapsPath, "");
        //    FengGameManagerMKII.FGM.BasePV.RPC("Chat", PhotonTargets.All, new object[]
        //    {
        //        VText.Text("Next map " + (random ? "(RANDOM) " : "") + ":", name, "!"),
        //        ""
        //    });
        //    VSettings.GameType = 3;
        //}
        ...
        private static void spawnPlayerCustomMap()
        {
