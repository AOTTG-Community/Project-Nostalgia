...
public class TITAN : Optimization.Caching.Bases.TitanBase
{
    ...
    {
        this.myLevel = level;
        this.myLevel = Mathf.Clamp(this.myLevel, 0.7f, 59f);
    ...
    private void Start()
    {
        ...
        this.myLevel = UnityEngine.Random.Range(0.5f, 3.5f);
    ...
    public void setAbnormalType(AbnormalType type, bool forceCrawler = false)
    {
        ...
        {
            num = 3;
            if (CacheGameObject.Find("Crawler") != null && UnityEngine.Random.Range(0, 1000) > 5)
            {
                num = 2;
            }
        }
        ...
        if (num == 4)
        {
            ...
            else
            {
                ...
                {
                    int wave = FengGameManagerMKII.FGM.Wave;
